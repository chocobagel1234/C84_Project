...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		if((keyPressed >=00 && keyPressed<=31)|| (keyPressed >=32 && keyPressed<=36)|| (keyPressed >=41 && keyPressed<=47)||  (keyPressed >=58 && keyPressed<=64)|| (keyPressed >=91 && keyPressed<=96)|| (keyPressed >=123 && keyPressed<=126))
		{
		specialkey();
